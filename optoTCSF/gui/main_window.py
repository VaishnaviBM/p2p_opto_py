...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.tabs.addTab(self.tcsf_tab, "2 · TCSF Estimator")
        self.tabs.addTab(self.opto_tcsf_tab, "3 · Opto TCSF Prediction")
        self.tabs.addTab(self.video_sim_tab, "4 · Video Simulation")
